function [evsi, grad1, grad2] = evsi_subgroups_normal_normal_analytical_n(n, N, mu0, n0, sigma, K, k, B)
...
evsi = 0;
gradtmp1 = zeros(n_subgroups, 1);
gradtmp2 = zeros(n_subgroups, 1);
for s = 1:n_subgroups
    [tmp, gradtmp1(s), gradtmp2(s)] = evsi_normal_normal_analytical_n(n(s), N(s), mu0(s), n0(s), sigma(s), K, k, B);
    evsi = evsi + tmp;
end
