function [enbs, grad1, grad2] = enbs_normal_normal_analytical_n(n, N, mu0, n0, sigma, K, k, B, c)
...
[evsi, evsi_g1, evsi_g2] = evsi_normal_normal_analytical_n(n, N, mu0, n0, sigma, K, k, B);
[cost, cost_g1, cost_g2] = linear_cost_n(n, c);
